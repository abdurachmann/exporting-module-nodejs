...
console.log('hasil dari ' + angka1 + ' ditambah angka ' + angka2 + ' = ' + calculatorClass1.penjumlahan());
console.log('hasil dari ' + angka1 + ' dikurang angka ' + angka2 + ' = ' + calculatorClass1.pengurangan());
console.log('hasil dari ' + angka1 + ' dikali angka ' + angka2 + ' = ' + calculatorClass1.perkalian());
console.log('hasil dari ' + angka1 + ' dibagi angka ' + angka2 + ' = ' + calculatorClass1.pembagian());
